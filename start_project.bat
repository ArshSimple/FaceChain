...
:: ===================================================
:: [CONFIGURATION] PATHS
:: Pointing to: D:\AA User File\Desktop\GitHub\FaceChain
:: ===================================================
set PROJECT_ROOT=D:\AA User File\Desktop\GitHub\FaceChain

:: 1. Start the Backend Server
echo [1/3] Launching Python Backend (Port 5000)...
:: We use quotes "" around the path to handle the spaces in "AA User File"
